...
var AddressController = /** @class */ (function () {
    ...
    AddressController.index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    AddressController.create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    AddressController.update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var token, userId, _b, id, title, description, longitude, latitude, phoneNumber, addressRepository, address, error_1, errors, e_2;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    if (address.userId !== userId) {
                        return [2 /*return*/, res.status(403).send({ code: 403, data: "Access Forbidden" })];
                    }
                    address.title = title;
                    address.description = description;
                    address.longitude = longitude;
    ...
    AddressController.delete = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var token, userId, id, addressRepository, address, error_2, e_3;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    token = jwtDecode(req.headers.authorization);
